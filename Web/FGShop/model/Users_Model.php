...
class Users_Model
{
 ...
 public function getNumRowReport() {
  ...
  public function encrypt_password($str) {
    ...
    // $encrypted = openssl_encrypt($str, 'aes-256-cbc', $cryptKey, 0, $iv);
    // $strEncoded = base64_encode($iv . $encrypted);
    return $str;
}
...
public function decrypt_password($str = "") {
  ...
  // $strDecoded = openssl_decrypt($encrypted, 'aes-256-cbc', $cryptKey, 0, $iv);
  return $str;
}
